...
<body>
    <form id="form1" runat="server">
        <div class="container-fluid">
            <div class="">
                <div class="card-body" id="pdf_content" runat="server">
                ...
                <div class="card-footer">
                    ...
                    <asp:Button ID="pdfbutton" runat="server" CssClass="btn btn-primary" OnClick="pdfbutton_Click" Text="save" />
